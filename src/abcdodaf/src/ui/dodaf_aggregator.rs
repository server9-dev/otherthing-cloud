...
impl DodafAggregator {
    ...
    pub fn aggregate_from_workspace(&mut self, workspace: &Workspace) {
        ...
        for doc in workspace.workflows() {
            ...
            for (_node_id, node) in doc.snarl.node_ids() {
                ...
                if let Some(ref dodaf_meta) = node.dodaf_metadata {
                    ...
                    if let Some(ref duration) = dodaf_meta.duration {
                        let minutes = match duration.unit {
                            ...
                            crate::dodaf::ov5::TimeUnit::Months => {
                                duration.value * 60.0 * 8.0 * 20.0
                            },
                        };
            ...
            if workflow_cost > 0.0 {
                self.cost_summary.by_workflow.insert(workflow_name.clone(), workflow_cost);
            }
    ...
    pub fn render(&mut self, ui: &mut egui::Ui, workspace: &Workspace) {
        ...
        // Tab selector
        ui.horizontal(|ui| {
            ui.selectable_value(&mut self.selected_tab, DodafTab::Capabilities, "🎯 Capabilities");
    ...
    fn render_capabilities(&self, ui: &mut egui::Ui) {
        ...
        egui::Grid::new("capabilities_grid").striped(true).show(ui, |ui| {
            ui.heading("ID");
            ui.heading("Name");
    ...
    fn render_performers(&self, ui: &mut egui::Ui) {
        ...
        egui::Grid::new("performers_grid").striped(true).show(ui, |ui| {
            ui.heading("ID");
            ui.heading("Name");
            ui.heading("Role");
            ui.heading("Tasks");
    ...
    fn render_activities(&self, ui: &mut egui::Ui) {
        ...
        egui::Grid::new("activities_grid").striped(true).show(ui, |ui| {
            ui.heading("ID");
            ui.heading("Name");
            ui.heading("Workflow");
            ui.heading("Node");
    ...
    fn render_costs(&self, ui: &mut egui::Ui) {
        ...
        if !self.cost_summary.by_workflow.is_empty() {
            ...
            egui::Grid::new("cost_by_workflow").striped(true).show(ui, |ui| {
                ui.heading("Workflow");
                ui.heading("Cost");
                ui.end_row();
        ...
        if !self.cost_summary.by_capability.is_empty() {
            ...
            egui::Grid::new("cost_by_capability").striped(true).show(ui, |ui| {
